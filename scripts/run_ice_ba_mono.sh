...
cmd="../bin/ice_ba --imgs_folder $EuRoC_PATH/MH_05_difficult --start_idx 0 --end_idx -1 --iba_param_path ../config/config_of_mono.txt  --gba_camera_save_path $EuRoC_PATH/result/MH_05_difficult.txt"
echo $cmd
eval $cmd
